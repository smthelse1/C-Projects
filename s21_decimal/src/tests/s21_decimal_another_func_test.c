...
START_TEST(truncate_7) {
  s21_decimal value_1 = {{123456, 0, 0, SIGN_MASK}};
  s21_set_scale(&value_1, 3);
  s21_decimal check = {{123, 0, 0, SIGN_MASK}};
...
START_TEST(round_11) {
  s21_decimal value_1 = {{7464923, 0, 0, SIGN_MASK}};
  s21_set_scale(&value_1, 5);
  s21_decimal check = {{75, 0, 0, SIGN_MASK}};
  s21_decimal result = {0};
...
START_TEST(round_12) {
  s21_decimal value_1 = {{7444923, 0, 0, SIGN_MASK}};
  s21_set_scale(&value_1, 5);
  s21_decimal check = {{74, 0, 0, SIGN_MASK}};
  s21_decimal result = {0};
  int return_value = s21_round(value_1, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
...
START_TEST(s21_decimal_negateTest) {
  s21_decimal x = {{100, 0, 0, SIGN_MASK}};
  ...
  s21_decimal m = {{100, 0, 0, 0}};
  s21_decimal n = {{0, 0, 0, 0}};
  s21_negate(m, &n);
  char res3[1000], res4[1000] = "100 0 0 2147483648";
  snprintf(res3, sizeof(char) * 1000, "%u %u %u %u", n.bits[0], n.bits[1],
           n.bits[2], n.bits[3]);
  ck_assert_str_eq(res3, res4);

  s21_decimal l = {{0, 0, 0, 0}};
  s21_decimal k = {{0, 0, 0, 0}};
  int err = s21_negate(l, &k);
  ck_assert_int_eq(err, 0);

  s21_decimal c;
  s21_decimal v;
  int error = s21_negate(c, &v);
  ck_assert_int_eq(error, 0);  // hhz

  s21_decimal q = {{0, 0, 1, 0}};
  s21_decimal w = {{0, 0, 1, SIGN_MASK}};
  ck_assert_int_eq(s21_negate(q, &w), s21_negate(q, &w));

  s21_decimal e = {{0, 4, 4, 0}};
  s21_decimal r = {{0, 4, 4, SIGN_MASK}};
  ck_assert_int_eq(s21_negate(e, &r), s21_negate(e, &r));

  s21_decimal t = {{0, 14, 14, 0}};
  s21_decimal y = {{0, 14, 14, SIGN_MASK}};
  ck_assert_int_eq(s21_negate(t, &y), s21_negate(t, &y));

  s21_decimal u = {{0, 999999, 999999, 0}};
  s21_decimal i = {{0, 999999, 999999, SIGN_MASK}};
  ck_assert_int_eq(s21_negate(u, &i), s21_negate(u, &i));
}
END_TEST
...
START_TEST(negate_5) {
  s21_decimal value_1 = {{5, 0xFFFFFFFF, 0, SIGN_MASK}};
...
Suite *init_suite_other() {
  ...
  tcase_add_test(tc_s21_round, round_10);
  tcase_add_test(tc_s21_round, round_11);
  tcase_add_test(tc_s21_round, round_12);
  // tcase_add_test(tc_s21_round, s21_round_8);
  tcase_add_test(tc_s21_round, s21_round_9);
  tcase_add_test(tc_s21_round, s21_round_12);
  tcase_add_test(tc_s21_round, s21_round_13);
  tcase_add_test(tc_s21_round, s21_roundTest1);
  tcase_add_test(tc_s21_round, s21_roundTest2);
  ...
  tcase_add_test(tc_s21_truncate, truncate_7);
  tcase_add_test(tc_s21_truncate, truncate_8);
  tcase_add_test(tc_s21_truncate, truncate_9);
  ...
  tcase_add_test(tc_s21_negate, s21_decimal_negateTest);
  tcase_add_test(tc_s21_negate, negate_0);
  tcase_add_test(tc_s21_negate, negate_1);
  tcase_add_test(tc_s21_negate, negate_2);
  tcase_add_test(tc_s21_negate, negate_3);
  tcase_add_test(tc_s21_negate, negate_5);
  tcase_add_test(tc_s21_negate, negate_6);
